...
import static com.video.common.constant.Constant.COUPON_CODE_PATTERN;
import static com.video.common.result.ResultCodeEnum.PARAM_ERROR;

/**
 * <h1 style='font-weight:500'>本来是天机学堂的兑换码生成算法，我给它拿来生成用户ID了</h1>
...
public class CodeUtil {
    ...
    public static String generateCode(long serialNum, long fresh) {
        // 1.生成明文
        long visibleCode = geneVisibleCode(serialNum, fresh);
        // 2.转码
        return Base32.encode(visibleCode);
    }
    ...
    public static long geneVisibleCode(long serialNum, long fresh) {
        ...
        return checkCode << CHECK_CODE_BIT_OFFSET | payload;
    }
    ...
    public static long parseCode(String code) {
        if (code == null || !code.matches(COUPON_CODE_PATTERN)) {
            // 兑换码格式错误
            throw new VideoException(PARAM_ERROR.getCode(), "无效兑换码");
        }
        // 1.Base32解码
    ...
    public static void main(String[] args) {
        System.out.println(CodeUtil.geneVisibleCode(1, 4589));
    }
}
