...
//    public final static long ACCESS_TOKEN_EXPIRATION = 60 * 60 * 1000 * 3L;//单位是毫秒，3小时
    public final static long ACCESS_TOKEN_EXPIRATION = 15 * 1000L;//测试用
//    public final static long REFRESH_TOKEN_EXPIRATION = 60 * 60 * 1000 * 24 * 3L;//单位是毫秒，3天
    public final static long REFRESH_TOKEN_EXPIRATION = 600 * 1000L;//测试用
